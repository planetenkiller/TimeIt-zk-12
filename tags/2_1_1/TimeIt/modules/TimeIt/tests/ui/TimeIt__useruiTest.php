...
class TimeIt__useruiTest extends ZkUnitUITestCase
{
    ...
    public function testSubscribtion()
    {
        ...
        $this->open("index.php?module=TimeIt&func=event&id=3");
        ...
        $this->click("viewUserLink");
        $this->assertTrue($this->isVisible("id=unsubscribeLink"));
    }

    public function testMonthViewJan()
    {   // //table[@class='ti-monthTable']//td[@class='ti-day ti-dayMonthOn']/div[@class='ti-daynum']/a[contains(.,'26')]/../../div[@class='ti-eventlist']
        $this->open("index.php?module=TimeIt&year=2009&month=1");
        $this->assertEquals("November < December < January 2009 > February > March", $this->getText("//div[@id='pn-maincontent']/table[2]/tbody/tr[1]/td/div/strong"));
    ...
    public function testMonthViewFeb()
    {
        ...
        $this->assertEquals("December < January < February 2009 > March > April", $this->getTable("//div[@id='pn-maincontent']/table[2].0.0"));
    ...
    public function testMonthViewMar()
    {
        ...
        $this->assertEquals("January < February < March 2009 > April > May", $this->getTable("//div[@id='pn-maincontent']/table[2].0.0"));
        ...
        $this->assertEquals("December < January < February 2010 > March > April", $this->getTable("//div[@id='pn-maincontent']/table[2].0.0"));
    ...
    {
        $this->open("index.php?module=TimeIt&func=event&id=".$this->sharedFixture->TimeIt_events['rec_1']['id']);
    ...
    function testChangeRecurrence()
    {
        ...
        $this->waitForPageToLoad("30000");
        $this->open("index.php?module=TimeIt&year=2009&month=2");
        $this->assertEquals("02 + \n [week] » rep 1 week\n » rep 1 year\n » rep 1 day", $this->getTable("//div[@id='pn-maincontent']/table[2].3.0"));
