 ...
 * @subpackage Plugins
 */
class tiFormDateInputYUI extends pnFormTextInput
{
    /**
    ...
    function render(&$render)
    {
        ...
        $result = '<span id="'.$this->id.'_dateinput" class="date yui-skin-sam" style="white-space: nowrap">';
        ...
        if ($firstTime)
        {
            $headers[] = 'http://yui.yahooapis.com/2.6.0/build/yahoo-dom-event/yahoo-dom-event.js';
            $headers[] = 'http://yui.yahooapis.com/2.6.0/build/calendar/calendar-min.js';
            $headers[] = 'http://yui.yahooapis.com/2.6.0/build/container/container_core-min.js';
            $headers[] = 'http://yui.yahooapis.com/2.6.0/build/element/element-beta-min.js';
            $headers[] = 'http://yui.yahooapis.com/2.6.0/build/button/button-min.js';
            $headers[] = 'modules/TimeIt/pnjavascript/tiformdateinputyui.js';
            PageUtil::addVar('stylesheet', 'http://yui.yahooapis.com/2.6.0/build/calendar/assets/skins/sam/calendar.css');
            PageUtil::addVar('stylesheet','http://yui.yahooapis.com/2.6.0/build/button/assets/skins/sam/button.css');
    ...
    if($this->multipleTime) {
            ...
            if($this->text)
            {
                $selected = ", '".date('n/j/Y', strtotime($this->text))."'";
            }
            $result .= "<script type=\"text/javascript\">
             tiformdateinputyuiSetup('$this->id'".$selected.");
            </script>";
        }
        return $result;
    }
...
function smarty_function_tiformdateinputyui($params, &$render)
{
    return $render->pnFormRegisterPlugin('tiFormDateInputYUI', $params);
}
