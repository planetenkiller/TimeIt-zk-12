...
class PNEventArray extends PNObjectArray
{
    ...
    public function eventsNew($where, $joins=array()) {
        $this->_objData = DBUtil::selectExpandedObjectArray('TimeIt_date_has_events', array_merge(array(array ('join_table'         => 'TimeIt_events',
                                                                                                        ...
                                                                                                        array ('join_table'         => 'TimeIt_events',
                                                                                                               ...
                                                                                                               'compare_field_join' => 'id',
                                                                                                               'join_method'        => 'LEFT JOIN')),$joins), $where);
...
array ('id','iid','title','text', 'title_translate', 'text_translate','data','allDay','allDayStart','allDayDur','repeatType','repeatSpec','repeatFrec','repeatIrg', 'startDate','endDate','sharing','group','status','subscribeLimit','subscribeWPend');
array ('a_id','a_iid','a_title','a_text', 'a_title_translate', 'a_text_translate','a_data','a_allDay','a_allDayStart','a_allDayDur','a_repeatType','a_repeatSpec','a_repeatFrec','a_repeatIrg', 'a_startDate','a_endDate','a_sharing','a_group','a_status','a_subscribeLimit','a_subscribeWPend');
array ('b_id','b_iid','b_title','b_text', 'b_title_translate', 'b_text_translate','b_data','b_allDay','b_allDayStart','b_allDayDur','b_repeatType','b_repeatSpec','b_repeatFrec','b_repeatIrg', 'b_startDate','b_endDate','b_sharing','b_group','b_status','b_subscribeLimit','b_subscribeWPend');