...
function eventEditInit()
{
    ...
    // observe any changes on the address
     Event.observe($('streat'), 'focus',function(event) 
                                         {
                                                 checkAddress($('streat').value);
                                         }, false);
     Event.observe($('streat'), 'blur',function(event) 
                                         {
                                                 checkAddressTwo($('streat').value);
                                         }, false);
     Event.observe($('houseNumber'), 'focus',function(event) 
                                         {
                                                 checkAddress($('houseNumber').value);
                                         }, false);
     Event.observe($('houseNumber'), 'blur',function(event) 
                                         {
                                                 checkAddressTwo($('houseNumber').value);
                                         }, false);
     Event.observe($('zip'), 'focus',function(event) 
                                         {
                                                 checkAddress($('zip').value);
                                         }, false);
     Event.observe($('zip'), 'blur',function(event) 
                                         {
                                                 checkAddressTwo($('zip').value);
                                         }, false);
     Event.observe($('city'), 'focus',function(event) 
                                         {
                                                 checkAddress($('city').value);
                                         }, false);
     Event.observe($('city'), 'blur',function(event) 
                                         {
                                                 checkAddressTwo($('city').value);
                                         }, false);
     Event.observe($('country'), 'focus',function(event) 
                                         {
                                                 checkAddress($('country').value);
                                         }, false);
     Event.observe($('country'), 'blur',function(event) 
                                         {
                                                 checkAddressTwo($('country').value);
                                         }, false);
