...
function TimeIt_calendarnav2block_display($blockinfo)
{
    ...
    $befor1 = pnModUrl('TimeIt', 'user', 'view', array('viewType' => 'month', 'month' => $befor1['mon'], 'year' => $befor1['year']));
    $after1 = pnModUrl('TimeIt', 'user', 'view', array('viewType' => 'month', 'month' => $after1['mon'], 'year' => $after1['year']));
    $befor2 = pnModUrl('TimeIt', 'user', 'view', array('viewType' => 'month', 'month' => $befor2['mon'], 'year' => $befor2['year']));
    $after2 = pnModUrl('TimeIt', 'user', 'view', array('viewType' => 'month', 'month' => $after2['mon'], 'year' => $after2['year']));
