...
class TimeIt_Manager_Event
{
     ...
     * @param TimeItFilter $filter_obj     Filter.
    ...
    public function getDailySortedEvents($start, $end, $cid, TimeItFilter $filter_obj=null, $args=array())
    {
        ...
        if ($filter_obj == null || !$filter_obj->hasFilterOnField('sharing')) {
            ...
            $where .= 'e.pn_sharing = 3 OR e.pn_sharing = 4 OR le.pn_sharing = 3 OR le.pn_sharing = 4)';
        ...
        foreach ($array as $obj) {
            if (!TimeIt_Util_Permission::canViewEvent($obj, ACCESS_OVERVIEW)) {
            ...
            $this->_getDailySortedEventsAddToArray($ret, $timestamp, $obj);
            $eventsAdded++;
