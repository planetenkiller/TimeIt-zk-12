...
function TimeIt_userapi_create($args)
{
    ...
    } else
    {
    	if(isset($args['obj']['__WORKFLOW__']))
    	{
    		...
    		if($args['obj']['__META__']['TimeIt']['preserve'])
    		{
    			$object->setPreserve(true);
    		}
    		$ret = $object->insert();
...
function TimeIt_userapi_navdates($args)
{
    ...
    { 
        ...
        $ret['dateFirstDayInWeek_FirstWeekOfMonth'] = DateUtil::getDatetime(mktime(0, 0, 0, ($month-1==0)?12:$month-1, $ret['startLastMonth'], $tYear), _DATEINPUT);
    } else
    {
