...
class TimeIt_Recurrence_Processor
{
     ...
     */
    public function __construct(TimeIt_Recurrence_Output $out, array $obj, $noIgnoreDateFilter=false, $customDatesToIgnore=null)
    {
...
class TimeIt_Recurrence_IgnoreDateFilter implements TimeIt_Recurrence_Output
{
    ...
    {
        if(!in_array( DateUtil::getDatetime($timestamp, DATEONLYFORMAT_FIXED), $this->dates)) {
