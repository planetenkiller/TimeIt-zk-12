...
require_once dirname(__FILE__).'/SyncML/State.php';
require_once dirname(__FILE__).'/SyncML/Command.php';
require_once dirname(__FILE__).'/SyncML/Command/SyncHdr.php';
require_once dirname(__FILE__).'/SyncML/Sync.php';
require_once dirname(__FILE__).'/SyncML/XMLOutput.php';
require_once dirname(__FILE__).'/SyncML/Backend.php';
...
class SyncML_ContentHandler {
    ...
    function process($request, $contentType, $respURI = null)
    {
        ...
        if (!$isWBXML) {
             ...
             * output. */
            require_once dirname(__FILE__).'/XML/WBXML/ContentHandler.php';
            ...
            /* WBXML code. */
            require_once dirname(__FILE__).'/XML/WBXML/Decoder.php';
            require_once dirname(__FILE__).'/XML/WBXML/Encoder.php';
