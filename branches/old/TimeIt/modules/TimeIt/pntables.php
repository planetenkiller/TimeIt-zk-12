...
function TimeIt_pntables()
{
    ...
    // indexes removed because mysql doesn't use these indexes
    ...
    $columns = array ('id'    	=> 'pn_id',
                      ...
                      'uid' 	=> 'pn_uid',
                      'status'  => 'pn_status',
                      'data'    => 'pn_data'); // 1 = ok, 0 = pending state
    ObjectUtil::addStandardFieldsToTableDefinition ($columns, 'pn_');
    ...
    $pntables['TimeIt_date_has_events_column_idx'] = array ('eid'      => 'eid',
                                                            'localeid' => 'localeid');
    ...
    // ---------------- syncml mapping table --------------------

    $pntables['TimeIt_syncml_map'] = DBUtil::getLimitedTablename('TimeIt_syncml_map');
    ...
    $pntables['TimeIt_syncml_map_column'] = $columns;
    $pntables['TimeIt_syncml_map_column_idx'] = array ('uid'      => 'uid',
                                                       'eid'      => 'eid',
                                                       'deviceid' => 'deviceid',
                                                       'cuid'     => 'cuid');


    $columns  = array('deviceid'    => 'C(255)',
                      'uid'         => "I",
                      'cuid'        => "C(255)",
                      'eid'         => "I",
                      'timestamp'   => "I"
                     );
    $pntables['TimeIt_syncml_map_column_def'] = $columns;

    // ---------------- syncml anchors table --------------------

    $pntables['TimeIt_syncml_anchors'] = DBUtil::getLimitedTablename('TimeIt_syncml_anchors');
    ...
    $pntables['TimeIt_syncml_anchors_column'] = $columns;
    ...
    $pntables['TimeIt_syncml_anchors_column_def'] = $columns;
